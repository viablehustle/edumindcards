import { type User, type InsertUser, type Flashcard, type InsertFlashcard } from "@shared/schema";
...
export interface IStorage {
  ...
  getFlashcardsBySubject(subject: string): Promise<Flashcard[]>;
...
export class MemStorage implements IStorage {
  ...
  private seedFlashcards() {
    const seedData: InsertFlashcard[] = [
      // Geology Cards
      {
        subject: "geology",
    ...
    seedData.forEach(data => {
      const id = randomUUID();
      const flashcard: Flashcard = { ...data, id };
